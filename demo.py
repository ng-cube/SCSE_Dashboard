...
"""
intro_with_icons = f"{smiley}{hi}{page_intro}{star}  \n You can select topics from the sidebar. To access individual professor profiles, navigate to the 'Professors' tab, and to compare their profiles, simply click on 'View More'."
